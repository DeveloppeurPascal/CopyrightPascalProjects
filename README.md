...
The comments are placed at the beginning of the source file before the standard start of the file content.

These are Pascal comments using ‘(* ... *)’ as a marker. The first line or the following line must contain ‘C2PP’ to be handled by the program. A file signature must be present before the end of the comment.

If the program does not find this type of comment, it will try to interpret the first XMLDoc comment and look for a signature as was used before 25 May 2025 in the first beta versions.
...
Visit [the Copyright Pascal Projects website](https://copyrightpascalprojects.olfsoftware.fr) to download the compiled version, learn more about how it works, access videos and articles, find out about the different versions available and their features, contact user support...
...
Documentation is exported in HTML by [DocInsight](https://devjetsoftware.com/products/documentation-insight/) or [PasDoc](https://pasdoc.github.io) to the /docs folder of the repository. You can also [access it online](https://developpeurpascal.github.io/CopyrightPascalProjects) through the hosting offered by GitHub Pages.

Further information (tutorials, articles, videos, FAQ, talks and links) can be found on [the project website](https://copyrightpascalprojects.olfsoftware.fr) or [the project devlog](https://developpeur-pascal.fr/copyright-pascal-projects.html).
...
If this license doesn't suit your needs (especially for a commercial project) I also offer [classic licenses for developers and companies](https://appstoresscreencapturesgenerator.olfsoftware.fr/).
